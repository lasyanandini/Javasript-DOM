...
function card(productName, productBrand, productPrice, productImage ){  
...
//clothingSection.appendChild(productCardElement);
...
productDetailsElement.append(productNameElement, productBrandElement, productPriceElement)
productCardElement.appendChild(productDetailsElement)
return productCardElement
} 
for (var i = 0; i < productList.length ; i++){
  var productCardElement =  card(productList[i].name, productList[i].brand, productList[i].price, productList[i].preview)
  if (productList[i].isAccessory == true){
    accessorySection.appendChild(productCardElement)
  } 
  else{
    clothingSection.appendChild(productCardElement)
  } 
